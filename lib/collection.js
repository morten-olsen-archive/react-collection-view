  ...
  _createClass(CollectionView, [{
    ...
    value: function componentWillReceiveProps(next) {
      ...
      this.calculatePositions(function () {
        var node = next.scroll.getScrollContainer();
        _this3.handleScroll({
          target: node
        });
      }, next);
    ...
    value: function toPixels(value) {
      ...
      matchGroups.forEach(function (match, index) {
        ...
        switch (unit.trim()) {
          case '%':
            {
              var innerWidth = _this4.state.innerWidth;
    ...
    value: function handleResize() {
      ...
      this.setState({
        ...
        _this5.calculatePositions(function () {
          _this5.handleScroll({ target: { scrollTop: node.scrollTop } });
        });
      });
    }
  }, {
    ...
    value: function calculatePositions(callback, next) {
      var _ref = next || this.props,
    ...
    value: function render() {
      var _props4 = this.props,
          items = _props4.items,
          delayFirstRender = _props4.delayFirstRender,
